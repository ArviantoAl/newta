                            ...
                            <table class="table">
                                ...
                                @foreach ($invoices as $no => $invoice)
                                    <tr>
                                        ...
                                        @if($invoice->status == 0)
                                            <td><div class="badge badge-info">Belum Dikirim Bagian Keuangan</div></td>
                                        @elseif($invoice->status == 1)
                                            ...
                                            @elseif($tanggal<=$invoice->tgl_tempo)
                                                <td><div class="badge badge-warning">Menunggu Pembayaran, Cek Email untuk Melihat Invoice/Tagihan Anda</div></td>
                                            @endif
