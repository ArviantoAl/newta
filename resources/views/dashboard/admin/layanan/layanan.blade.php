            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-md">
                            ...
                            @foreach ($layanans as $no => $layanan)
                                <tr>
                                    ...
                                    <td>{{ $layanan->harga }}</td>
                                    <td>
                                        <a class="btn btn-warning" href="{{ route('admin.editlayanan', $layanan->id_layanan) }}">Edit</a>
                                    </td>
                                    <td>
                        ...
                        <a class="btn btn-success" href="{{ route('admin.tambahlayanan') }}">Tambah Kategori</a>
                    </div>
                </div>
            </div>
        </div>
