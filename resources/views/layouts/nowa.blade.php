                ...
                <div class="main-header-left ">
                    <div class="responsive-logo">
                        <a href="index.html" class="header-logo">
                            ...
                            <img src="{{ asset('nowa_assets') }}/img/brand/logo-white.png" class="mobile-logo dark-logo-1" alt="logo">
                        </a>
                    </div>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent-4">
                            <ul class="nav nav-item header-icons navbar-nav-right ms-auto">
                                ...
                                <li class="dropdown main-profile-menu nav nav-item nav-link ps-lg-2">
                                    <a class="new nav-link profile-user d-flex" href="" data-bs-toggle="dropdown"><img alt="" src="{{ asset('nowa_assets') }}/img/faces/2.jpg" class=""></a>
                    ...
                    <ul class="side-menu">
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                ...
                                <li><a class="slide-item" href="file-manager.html">File-manager</a></li>
                                <li><a class="slide-item" href="file-manager1.html">File-manager1</a></li>
                                <li><a class="slide-item" href="file-details.html">File-details</a></li>
                            </ul>
                        </li>
                        <li class="slide">
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                ...
                                <li><a class="slide-item" href="blog-details.html">Blog-details</a></li>
                                <li><a class="slide-item" href="edit-post.html">Edit-post</a></li>
                                <li><a class="slide-item" href="file-attached-tags.html">File Attachments</a></li>
                            </ul>
                        </li>
                            ...
                            <ul class="slide-menu">
                                ...
                                <li class="sub-slide">
                                    ...
                                    <ul class="sub-slide-menu">
                                        ...
                                        <li><a class="sub-side-menu__item" href="switcher-1.html">Switcher-1</a></li>
                                    </ul>
                                </li>
                                <li class="sub-slide">
                                    ...
                                    <ul class="sub-slide-menu">
                                        <li><a class="sub-side-menu__item" href="shop.html">Shop</a></li>
                                ...
                                <li><a class="slide-item" href="profile-notifications.html">Notifications-list</a></li>
                                <li><a class="slide-item" href="aboutus.html">About us</a></li>
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                ...
                                <li><a class="slide-item" href="icons2.html">Material Design Icons</a></li>
                                <li><a class="slide-item" href="icons3.html">Simple Line Icons</a></li>
                                <li><a class="slide-item" href="icons4.html">Feather Icons</a></li>
                                <li><a class="slide-item" href="icons5.html">Ionic Icons</a></li>
                                <li><a class="slide-item" href="icons6.html">Flag Icons</a></li>
                                <li><a class="slide-item" href="icons7.html">Pe7 Icons</a></li>
                                <li><a class="slide-item" href="icons8.html">Themify Icons</a></li>
                                <li><a class="slide-item" href="icons9.html">Typicons Icons</a></li>
                                <li><a class="slide-item" href="icons10.html">Weather Icons</a></li>
                                <li><a class="slide-item" href="icons11.html">Material Icons</a></li>
                                <li><a class="slide-item" href="icons12.html">Bootstrap Icons</a></li>
                            </ul>
                        </li>
                        <li class="slide">
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                ...
                                <li><a class="slide-item" href="form-editor.html">Form Editor</a></li>
                                <li><a class="slide-item" href="form-sizes.html">Form-element-sizes</a></li>
                                <li><a class="slide-item" href="form-input-spinners.html">Form Input Spinners</a></li>
                            </ul>
                        </li>
                        <li class="slide">
